...
const $c3f51faaa3dc8b2a$export$98e6a39c04603d36 = (element, attrName, fullListOfTokens, debug = false)=>{
    ...
    const getObjectWithProperty = (propertyToken)=>{
        ...
        const obj = element.tagName === "P-CANVAS" || element.tagName === "P-CANVAS-3D" || attrName === "repeat" || attrName === "change" || propName === "above_sibling" || propName === "parent" || propName === "canvas" || propName === "above_siblings_off" ? element : element.parentElement;
 ...
 * </html>
 * ```
 */ class $109b9a5ca7a37440$var$Sketch extends HTMLElement {
    static elementName = "p-sketch";
    constructor(){
        super();
        if (this.hasAttribute("path")) {
            if (this.children.length) console.error("A sketch element has both a 'path' attribute and children, but it may only have one or the other.");
            else {
     ...
     #convertXML(e) {
        ...
        const markerCanvasElements = document.querySelectorAll("p-canvas, p-canvas-3d");
...
const $79ce0e365a23b6d5$export$a11dc51f2ecd743e = (baseClass)=>class P5Extension extends (0, $dfaf816c8f7968eb$export$df7182d31779a5d2)((0, $03bbbf8eda9a336e$export$f5ddaad6515de8cc)((0, $78e88c2be3b82581$export$a58b47d028f9234f)((0, $16ac526ed636526d$export$b46a7ea7c25c5e6d)((0, $9b76c1f65c019db4$export$ee3de0a7dd131a91)((0, $bd52bf81ac7b5a81$export$9f9bf41e917f10e)((0, $74cf9122b1ef1f14$export$89e97ff02600e0c0)((0, $36d0bcbd88d70227$export$480a8cd27449d6bd)(baseClass)))))))) {
     ...
     */  #setupEvalFns() {
            ...
            let obj = this.parent;
            while(obj){
                for (const { name: name  } of obj.attributes)if (name !== "style") inheritedAttributes.add(name);
...
const $a7d17c9282527449$var$addCanvasProperties = (baseClass)=>class extends baseClass {
        #background;
        #dom_element;
        /**
     ...
     */ get height() {
        ...
        set height(val) {
            if (isNaN(val)) {
                console.error(`The canvas' height was set to ${val}, but it can only be set to a number`);
                return;
            }
     ...
     */ get width() {
        ...
        set width(val) {
            if (isNaN(val)) {
                console.error(`The canvas' width was set to ${val}, but it can only be set to a number`);
                return;
            }
...
const $a7d17c9282527449$var$addCanvasMethods = (baseClass)=>class extends baseClass {
        attributeInherited(attributeName) {
        ...
        create_element(tagName) {
            ...
            if (secondTryElement.constructor.name === "HTMLUnknownElement") console.error(`create_element() was called with tag ${tagName}, but this is not a recognized tag. ` + `This may be due to a difference in spelling.`);
            else {
        ...
        runCode() {
            ...
            const sketch = (pInst)=>{
                ...
                pInst.setup = function() {
                    ...
                    const canvasWidth = markerCanvas.hasAttribute("width") ? (0, $a2ba0be321a8c9b5$export$67beed298888a38b)(markerCanvas, "width", markerCanvas.getAttribute("width"))() : markerCanvas.window.width;
                    const canvasHeight = markerCanvas.hasAttribute("height") ? (0, $a2ba0be321a8c9b5$export$67beed298888a38b)(markerCanvas, "height", markerCanvas.getAttribute("height"))() : markerCanvas.window.height;
                    pInst.createCanvas(canvasWidth, canvasHeight, markerCanvas.constructor.renderer);
                    //  Set default background to light gray
                    markerCanvas.background = pInst.color(220);
                    if (markerCanvas.style.display === "") markerCanvas.style.display = "none";
                };
                pInst.draw = function() {
 ...
 * ```<canvas-3d>```.
 */ class $a7d17c9282527449$var$Canvas extends $a7d17c9282527449$var$addCanvasMethods($a7d17c9282527449$var$addCanvasProperties((0, $79ce0e365a23b6d5$export$a11dc51f2ecd743e)((0, $db244738e3d6357d$export$a9e2f2714159e1ff)((0, $2097739565d80955$export$cd9f7ba93ec6c49f)((0, $3a08fcf437e8d724$export$c0049cef078ecb01)(HTMLElement)))))) {
    static renderer = "p2d";
    constructor(){
        super();
 ...
 */ class $a7d17c9282527449$var$WebGLCanvas extends $a7d17c9282527449$var$addCanvasMethods($a7d17c9282527449$var$addCanvasProperties((0, $79ce0e365a23b6d5$export$a11dc51f2ecd743e)((0, $db244738e3d6357d$export$a9e2f2714159e1ff)((0, $2097739565d80955$export$7d759072b2be4e22)((0, $3a08fcf437e8d724$export$bc17fd552ac7bdac)(HTMLElement)))))) {
    #bezier_detail;
    #curve_detail;
    #debug_mode;
    #orbit_control;
...
(0, $1b3618ac1b6555cf$export$49218a2feaa1d459)("selectAll", "removeElements", "createDiv", "createP", "createSpan", "createImg", "createA", "createSlider", "createButton", "createCheckbox", "createSelect", "createRadio", "createColorPicker", "createInput", "createFileInput", "createVideo", "createAudio", "createCapture");
